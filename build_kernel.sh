...
zip -r Ultimate-Kernel-$TARGET-7.0.zip .
tar -H ustar -c ${KERNELDIR}/output/$TARGET/enes/boot.img > Ultimate-Kernel-$TARGET-7.0.tar
md5sum -t Ultimate-Kernel-$TARGET-7.0.tar >> Ultimate-Kernel-$TARGET-7.0.tar
mv Ultimate-Kernel-$TARGET-7.0.tar Ultimate-Kernel-$TARGET-7.0.tar.md5
